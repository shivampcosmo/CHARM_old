...
#SBATCH --job-name=RUN_LONGTRAIN_Ntot_M1_Mdiff_test_256_condFPMFOF_200c_nc4_Nmax8
#SBATCH -p gpu
...
time srun python /mnt/home/spandey/ceph/AR_NPE/notebooks/TEST_ROCKSTAR_RUNS/run_Ntot_M1_Mdiff.py LONGTRAIN_run_Ntot_M1_Mdiff_256_condFPMFOF_cic_200c_lgMmin7e12_Nmax8_nc4.yaml
echo "done"
