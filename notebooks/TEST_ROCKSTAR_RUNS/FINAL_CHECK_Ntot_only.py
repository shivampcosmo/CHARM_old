...
run_config_name = 'run_Ntotonly_128_condFPM_uniformcic_fof_lgMmin1e13_wL2norm_highknots.yaml'
...
save_bestfit_model_dir = '/mnt/home/spandey/ceph/AR_NPE/' + 'TRAIN_ROCKSTAR_FOF/FINALTEST_SUBSEL_Ntotonly_plexp_ns_' + str(len(ji_array)) + \
                            '_cond_sim_' + cond_sim  \
