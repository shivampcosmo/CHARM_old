...
#SBATCH --job-name=run_test_128_condQ_pylianscic_200c_lgMmin5e13
#SBATCH -p gpu
#SBATCH -C a100,ib
#SBATCH --gpus=1
...
time srun python /mnt/ceph/users/spandey/AR_NPE/nf/run_final.py run_test_128_condQ_pylianscic_200c_lgMmin5e13.yaml
echo "done"
