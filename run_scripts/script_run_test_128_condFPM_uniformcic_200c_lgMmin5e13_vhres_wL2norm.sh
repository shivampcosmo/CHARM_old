...
#SBATCH --job-name=run_test_128_condFPM_200c_lgMmin5e13_vhres_wL2norm
#SBATCH -p gpu
#SBATCH -C h100,ib
#SBATCH --gpus=1
...
time srun python /mnt/ceph/users/spandey/AR_NPE/nf/run_final.py run_test_128_condFPM_uniformcic_200c_lgMmin5e13_vhres_wL2norm.yaml
echo "done"
